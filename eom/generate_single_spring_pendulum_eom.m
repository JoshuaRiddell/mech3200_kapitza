function [] = generate_single_sprint_pendulum_eom(values)
    ...
    FID = fopen('functions/single_spring_pendulum_func.m', 'w');
    ...
    FID = fopen('functions/single_spring_pendulum_spatial.m', 'w');
